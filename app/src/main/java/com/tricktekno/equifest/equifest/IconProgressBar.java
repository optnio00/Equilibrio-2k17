...
public class IconProgressBar extends View {
    ...
    public IconProgressBar(Context context, AttributeSet attrs) {
        ...
        front = BitmapFactory.decodeResource(context.getResources(),R.drawable.logosplash);
        back = BitmapFactory.decodeResource(context.getResources(),R.drawable.logosplash);
    }
